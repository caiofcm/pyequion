...
REGEX_FUNC_DEFINITION = u'def\s+\w+\([\w,\s]+\)\:'
...
def string_lambdastr_as_function(expr, x, a = None, fun_name = None, use_numpy=False,
    ...
    content = content.replace('erf(', 'math.erf(') #this is an error, lambdastr should be keeping math or numpy, check later
...
def numbafy_function_string(s, numba_kwargs_string = '',
    func_additional_arg=''):
