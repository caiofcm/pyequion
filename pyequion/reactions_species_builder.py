...
# Irreversible Equations "Database"
# This list is far from extensive. Strong electrolytes should be added here.
...
def create_list_of_mass_balances_engine(
    ...
    if not element_list:
        ...
        ] and not (closing_equation_type == ClosingEquationType.PH and feed_list == ['CO2']):  # CARBON_TOTAL STAYS OR NOT?
