...
from utils_tests import (assert_solution_result,
...
def test_phreeqpython_nahco3_cacl2_closed_open():
    ...
    solution = solve_solution(comp_dict, initial_feed_mass_balance=['Cl-'],
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=comp_dict['NaHCO3'])
    assert_solution(solution, solution_ref1)

    solution_ref2 = REF_SOLUTIONS[fname][1]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.OPEN, initial_feed_mass_balance=['Cl-'])
...
def test_phreeqpython_nahco3_cacl2_closed_15_5():
    ...
    solution_ref1 = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict, initial_feed_mass_balance=['Cl-'],
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=15.0)
    print('')
...
def test_phreeqpython_baco3_cacl2_closed_5_2():
    ...
    solution_ref1 = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict, initial_feed_mass_balance=['Cl-'],
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=5.0)
...
def test_phreeqpython_baco3_closed():
    ...
    solution_ref = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=1.0)
    assert_solution(solution, solution_ref)
...
def test_phreeqpython_baco3_closed_15():
    ...
    solution_ref = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=comp_dict['BaCO3'])
...
def test_phreeqpython_caco3_closed_100():
    ...
    solution_ref = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=comp_dict['CaCO3'])
    assert_solution(solution, solution_ref, tol={'pH': 1e-2})
    assert_solid(solution, solution_ref, tol={'si': 1e-1})
...
def test_phreeqpython_caco3_closed_Thot():
    ...
    solution_ref = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=comp_dict['CaCO3'], TC=TC)
    assert_solution(solution, solution_ref, tol={'pH': 1e-2})
    assert_solid(solution, solution_ref, tol={'si': 1e-1})


@pytest.mark.xfail(reason="I did not implement delta_h for species without a logK(T) expression")
...
def test_phreeqpython_cacl2_baco3_nahco3_closed():
    ...
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.CARBON_TOTAL, carbon_total=c_tot, initial_feed_mass_balance=['Cl-'])
    print('')
    assert_solid(solution, solution_ref)
...
def test_phreeqpython_cacl2_closed_and_open():
    ...
    solution_ref1 = REF_SOLUTIONS[fname][0]
    solution = solve_solution(comp_dict,
        close_type=ClosingEquationType.NONE, initial_feed_mass_balance=['Cl-'])
    assert_solution(solution, solution_ref1, tol={'pH': 1e-2})
...
def _test_phreeqpython_cacl2_caso4_closed():
    ...
    assert_solution(solution, solution_ref, tol={'pH': 1e-2, 'I': 1e-1})
    print('')
    assert_solid(solution, solution_ref, tol={'si': 1e-1}) #small error in gypsum...
...
def test_precip_baco3_cacl2():
    EXPECTED = {
        ...
        'I': (99.792e-3, 1.0),
        'sat-conc': {
            'Calcite': (1.54e+01*1e-3, 3.0),
            'Witherite': (6.46e+01*1e-3, 3.0),
        }
    }
...
def test_precip_baco3_cacl2_nahso4():
    EXPECTED = {
        ...
        'I': (100.412e-3, 1.0),
        'sat-conc': {
            'Calcite': (1.85e+01*1e-3, 3.0),
            'Barite': (2.00e+01*1e-3, 3.0),
            'Witherite': (4.74e+01 *1e-3, 3.0),
        }
    }
    comp_dict = {'BaCO3':80.0, 'CaCl2':33.25, 'NaHSO4': 20.0}
    # comp_dict = {'NaHCO3':2.0, 'CaCl2':1.0}
